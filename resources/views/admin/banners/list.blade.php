...
<section class="content-header">
				...
				<section class="content">
					...
					@include('admin.message')
						...
						<form method="get" action="">
							...
							<button type="button" onclick="window.location.href='{{route('banners.index') }}' " class="btn btn-default btn-sm">Reset</button>
							</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <img src="{{asset('uploads/banner/large/'.$row->banner_image )}}" class="img-thumbnail" width="50" >
                                    @else
                                    ...
                                    <td>
                                        ...
                                        <img src="{{asset('uploads/banner/small/'.$row->m_image )}}" class="img-thumbnail" width="50" >
                                        @else
                                        <img src="{{asset('admin-assets/img/default-150x150.png')}}" class="img-thumbnail" width="50" >
                ...
                @else
                <tr>
                    <td colspan="8">Banner Not Found!!</td>
                </tr>
                @endif
            </tbody>
		</table>
			...
			{{ $banners->onEachSide(10)->links('pagination::bootstrap-5') }}

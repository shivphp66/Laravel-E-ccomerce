    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <form method="GET" name="" id="" action="{{ route('pages.index')}}">
                    <div class="input-group input-group" style="width: 250px;">
                        <input type="text" value="{{ Request::get('searchkey')}}" name="searchkey" class="form-control float-right" placeholder="Search">
            ...
            <div class="card-footer clearfix">
                {{ $pages->onEachSide(10)->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
    <!-- /.card -->

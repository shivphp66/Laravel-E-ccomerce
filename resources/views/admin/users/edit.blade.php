    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('users.create') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option {{(!empty($user->status) && $user->status=='1')?'selected' : ''}} value="1">Active</option>
                                <option {{(!empty($user->status) && $user->status=='0')?'selected' : ''}}  value="0">Block</option>
                            </select>
                            <p></p>
                        </div>
                    </div>

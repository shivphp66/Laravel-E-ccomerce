					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" name="slug" value="{{ $sub_category->slug }}" id="slug" class="form-control" placeholder="Slug">
								<p></p>	
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<select name="status" id="status" class="form-control"> 
									...
									<option {{ $sub_category->status ==0 ? 'selected':'' }} value="0">Deactive</option>
								</select>	
							</div>
						</div>	
